...
namespace ISM3025
{
    internal class ModSettings
    {
        ...
        public bool SetContractParticipants = true;
        public float MajorInfluence = 1.3f;
        public float MinorInfluence = 1.0f;

        public string NavRoomScreenTexturePath = "";

        public Dictionary<string, float[]> FactionColors = new Dictionary<string, float[]>();
        public Dictionary<string, float[]> MajorFactionPositions = new Dictionary<string, float[]>();
        public Dictionary<string, float[]> MinorFactionPositions = new Dictionary<string, float[]>();
